...
class LimitElement extends Serializable {
  ...
  @BeanProperty var combineCount = 3
  @BeanProperty var maxDepth = 5
  @BeanProperty var hours = 6

  def this(minScale:Float, maxScale:Float, minMoney:Int, singleScale:Float, combineNum:Int, combineCount:Int, maxDepth:Int, hours:Int){
    this()
